...
class RegistrasiResponse {
  ...
  factory RegistrasiResponse.fromJson(Map<String, dynamic> json) =>
      RegistrasiResponse(
        status: json["status"],
        message: json["message"],
        data:
            json["data"] == null ? null : RegistrasiData.fromJson(json["data"]),
      );
...
class RegistrasiData {
  ...
  factory RegistrasiData.fromJson(Map<String, dynamic> json) => RegistrasiData(
        iduser: json["iduser"],
